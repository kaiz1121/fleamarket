...
import com.zk.flea.dao.ProductDao;
import com.zk.flea.exception.AddProductException;
import com.zk.flea.exception.FindProductByIdException;
import com.zk.flea.exception.ListProductException;
import com.zk.flea.model.PageBean;
import com.zk.flea.model.Product;
...
public class ProductService {
	...
	public PageBean findGoodsByName(int currentPage, int currentCount,
		...
		try {
			...
			e.printStackTrace();
			throw new RuntimeException("前台搜索框根据物品名查询商品失败！");
		}
	}
