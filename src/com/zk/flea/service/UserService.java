...
import com.zk.flea.dao.UserDao;
import com.zk.flea.exception.ActiveUserException;
import com.zk.flea.exception.RegisterException;
import com.zk.flea.model.User;
import com.zk.flea.utils.MailUtils;
...
public class UserService {
	...
	public void register(User user) throws RegisterException {
		...
		try {
			...
			// 发送激活邮件
			String emailMsg = "感谢您注册校园二手商城，点击<a href='http://localhost:8080/fleamarket/activeUser?activeCode="
					+ user.getActiveCode() + "'>&nbsp;激活&nbsp;</a>后使用。<br>为保障您的账户安全，请在24小时内完成激活操作&nbsp;<br>不要担心，我是张凯";
