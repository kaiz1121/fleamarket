...
<%@taglib prefix="p" uri="http://www.zk.com/tag"%>
			...
			<tr>
				<td>
					...
					<table cellspacing="0" class="infocontent">
						<tr>
							<td>
								<img src="${pageContext.request.contextPath}/client/ad/ad_cart.png" width="900" height="89" />
								<table width="100%" border="0" cellspacing="0">
									<tr>
										<td>
											<img src="${pageContext.request.contextPath}/client/images/buy1.png" width="530" height="40" />
										</td>
									</tr>
									<tr>
										<td>
											...
											<div style="text-align:right; margin-top:10px">
												<a href="${pageContext.request.contextPath}/showProductByPage"><!-- 继续购物-跳转到显示所有商品界面 -->
													<img src="images/gwc_jx.gif" border="0" />
												</a>
												&nbsp;&nbsp;&nbsp;&nbsp;
												<a href="${pageContext.request.contextPath}/client/order.jsp"><!-- 结算，跳转到订单界面 -->
